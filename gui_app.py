...
class SmartInternetTroubleshooter(tk.Tk):
    ...
    def _build_window(self):
        ...
        self.discover_button.pack(side=tk.LEFT, padx=(8, 0))
        ...
        self.stop_discovery_button.pack(side=tk.LEFT, padx=(8, 0))
        ttk.Label(
            device_actions,
    ...
    def internet_quality_test(self):
        def task():
            for line in internet_quality.run_internet_quality_test(progress_callback=self.write_line):
